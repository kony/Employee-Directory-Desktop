...
/** Identity Options**/
kony.sdk.OAUTH_REDIRECT_SUCCESS_URL = "success_url";
//OAuth for IE11 Workaround Constants; MFSDK-3657
kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL = "IE11CrossDomainOAuthBaseUrl";
kony.sdk.KNY_OAUTH_REDIRECT_HTML = "KNYOAuthRedirect.html";
kony.sdk.KNY_OAUTH_CALLBACK_HTML = "KNYOAuthCallback.html";
kony.sdk.KNY_OAUTH_REDIRECT_URL = "kny_oauth_redirect_url";
                    ...
                    if (kony.sdk.getSdkType() === "plain-js"){
                        ...
                        if(options && options["browserWidget"] && kony.type(options["browserWidget"]) === "kony.ui.Browser") {
                            ...
                            if (options && options["success_url"]) {
                                ...
                                var success_url = options["success_url"];
                                if (kony.sdk.getPlatformName() === "android") {
                                    success_url = encodeURIComponent(decodeURIComponent(options["success_url"]));
                                }

                                oauthOptions["success_url"] = success_url;
                            }
                        }

                        if (options && kony.sdk.util.isNonEmptyString(options[kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL])) {
                            oauthOptions[kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL] = options[kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL];
                        }
 ...
 * @returns {boolean}
 */
kony.sdk.util.isNonEmptyString = function(str){
...
function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
    ...
    function constructURLIE11(crossPlatformBaseURL, identityOAuthUrl) {
        ...
        identityOAuthUrl = identityOAuthUrl + "&" + kony.sdk.OAUTH_REDIRECT_SUCCESS_URL + "=" +
            encodeURIComponent(crossPlatformBaseURL + "/" + kony.sdk.KNY_OAUTH_CALLBACK_HTML);

        //Invoking the identity through the injected Redirect Page to overcome IE imposed cross domain security restrictions.
        var finalRequestUrl = crossPlatformBaseURL + "/" + kony.sdk.KNY_OAUTH_REDIRECT_HTML + "?" +
            kony.sdk.KNY_OAUTH_REDIRECT_URL + "=" + encodeURIComponent(identityOAuthUrl);
    ...
    if (typeof(XMLHttpRequest) !== 'undefined') {
		...
		var _listener = function (event) {
             ...
             */
            if(kony.sdk.util.isNonEmptyString(_contents) && !kony.sdk.isJson(_contents)) {
                _popup.close();
                _detachEvent();
                try {
        ...
        if(isLogout){
            ...
            if (isMFVersionCompatible && kony.sdk.util.checkForIE11() &&
                kony.sdk.util.isJsonObject(options) && options.hasOwnProperty(kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL)) {
                requestUrl = constructURLIE11(stripTrailingCharacter(options[kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL], "/"), requestUrl);
            }
        }
		...
		function handleRequestCallback(browserWidget, params) {
			...
			if (!isLoginCallbackInvoked && typeof(params.queryParams) !== "undefined" && typeof(params.queryParams.code) !== "undefined") {
                ...
                isLoginCallbackInvoked = true;
				callback(urlType, {error: params.queryParams.error}, headers, true);
            }
			return false;
		}
	}
