        ...
        initGettersSetters: function() {
            defineSetter(this, 'enableMenuItemAnimation', function(val) {
                ...
                if (val !== undefined && val !== null && val !== "" && typeof val === 'boolean') {
                    ...
                    throw {
                        message: 'wrong data passed for enableMenuItemAnimation of slidingMenu',
                        Error: 'Wrong enableMenuItemAnimation'
                    };
                }
            ...
            defineSetter(this, 'enableSeparator', function(val) {
                ...
                if (val !== undefined && val !== null && val !== "" && typeof val === 'boolean') {
                    ...
                    throw {
                        message: 'wrong data passed for enableSeparator of slidingMenu',
                        Error: 'Wrong enableSeparator'
                    };
                }
            ...
            defineSetter(this, 'animationSpeed', function(val) {
                ...
                if (val !== undefined && val !== null && val !== "") {
                    ...
                    throw {
                        message: 'wrong data passed for animationSpeed of slidingMenu',
                        Error: 'Wrong animationSpeed'
                    };
                }
            ...
            try {
                ...
                for (var i in options) {
                    ...
                    if (suboption.length > 0 && suboption[0] !== null) {
                        if (options[i].base64 !== undefined) data.push([options[i].menuItemName, {
                            base64: options[i].base64
                        }, suboption]);
                        else data.push([options[i].menuItemName, options[i].menuItemIcon, suboption]);
                    } else {
                        data.push(options[i]);
                    }
                }
