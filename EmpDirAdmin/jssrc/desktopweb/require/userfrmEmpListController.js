define({
    ...
    onSegmenFilterClick: function(eventobject) {
        var selectedItemDept = this.view.segDepartment.selectedRowItems;
    ...
    filter: function(selectedDept, selectedDesignation) {
        ...
        for (i = 0; i < this.parsedEmployeeList.length; i++) {
            ...
            if (this.parsedEmployeeList[i] !== null && this.parsedEmployeeList[i] !== undefined && this.parsedEmployeeList[i].department[0] !== null && this.parsedEmployeeList[i].department[0] !== undefined && this.parsedEmployeeList[i].department[0].Name !== null && this.parsedEmployeeList[i].department[0].Name !== undefined) {
                if (this.parsedEmployeeList[i].department[0].Name.indexOf(selectedDept) !== -1) {
                    isDepartmentMatched = true;
                }
            }
            if (this.parsedEmployeeList[i] !== null && this.parsedEmployeeList[i] !== undefined && this.parsedEmployeeList[i].designation[0] !== null && this.parsedEmployeeList[i].designation[0] !== undefined && this.parsedEmployeeList[i].designation[0].Name !== null && this.parsedEmployeeList[i].designation[0].Name !== undefined) {
     ...
     * @param {JSON} - 
     **/
    processEditIcon: function(rowIndex) {
        globEmpOperatioMode = "edit";
        this.processRowSelection(this.employeeList[rowIndex]);
    },
    /**
