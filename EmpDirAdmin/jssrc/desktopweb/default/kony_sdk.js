...
function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
    ...
    function constructURLIE11(crossPlatformBaseURL, identityOAuthUrl) {
        ...
        identityOAuthUrl = identityOAuthUrl + "&" + kony.sdk.OAUTH_REDIRECT_SUCCESS_URL + "=" + encodeURIComponent(crossPlatformBaseURL + "/" + kony.sdk.KNY_OAUTH_CALLBACK_HTML);
        //Invoking the identity through the injected Redirect Page to overcome IE imposed cross domain security restrictions.
        var finalRequestUrl = crossPlatformBaseURL + "/" + kony.sdk.KNY_OAUTH_REDIRECT_HTML + "?" + kony.sdk.KNY_OAUTH_REDIRECT_URL + "=" + encodeURIComponent(identityOAuthUrl);
    ...
    if (typeof(XMLHttpRequest) !== 'undefined') {
        ...
        if (isLogout) {
            ...
            if (isMFVersionCompatible && kony.sdk.util.checkForIE11() && kony.sdk.util.isJsonObject(options) && options.hasOwnProperty(kony.sdk.IE11_CROSS_DOMAIN_OAUTH_BASE_URL)) {
